...
export function UserMentionWithPopover({
  ...
  return (
    ...
    >
      <span
        className={cn(
          'mention mention-user inline-flex items-center px-1.5 py-0.5 rounded text-sm',
  ...
  return (
    <div className={cn('w-64 p-4', className)}>
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <h4 className="font-semibold text-sm text-warning">{title}</h4>
          <p className="text-xs text-muted-foreground mt-1">{description}</p>
        </div>
      </div>

      <div className="mt-3 p-2 rounded-md bg-warning/5 border border-warning/10">
