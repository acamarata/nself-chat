...
export function VideoPlayer({
  ...
  return (
    ...
    >
      ...
      {/* Buffering indicator */}
      {isBuffering && (
        <div className="absolute inset-0 flex items-center justify-center bg-black/30" data-testid="buffering-indicator">
      ...
      {!isPlaying && !isBuffering && (
        <div className="absolute inset-0 flex items-center justify-center" data-testid="play-overlay">
          <button
            onClick={togglePlay}
