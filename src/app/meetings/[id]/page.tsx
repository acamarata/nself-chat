  ...
  if (pageState === 'ended') {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white">
        ...
        <p className="text-gray-400 mb-6">This meeting has ended.</p>
        <Button onClick={() => router.push('/meetings')}>
          <ArrowLeft className="h-4 w-4 mr-2" />
          Back to Meetings
        </Button>
    ...
    return (
      <div className="flex min-h-screen bg-gray-900 text-white">
        ...
        <div className="flex-1 flex items-center justify-center p-8">
          <div className="relative bg-gray-800 rounded-2xl overflow-hidden w-full max-w-2xl aspect-video">
            {previewVideoOn ? (
        ...
        {/* Join Panel */}
        <div className="w-96 border-l border-gray-700 p-8 flex flex-col">
          <div className="flex-1">
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-center gap-3">
                ...
                {meeting.roomType === 'screenshare' && <Monitor className="h-5 w-5 text-purple-400" />}
