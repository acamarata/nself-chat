      ...
      it('should reset all unread counts', () => {
        act(() => {
          useNotificationStore.getState().addNotification(
            createTestNotification({ type: 'mention', channelId: 'channel-1' })
          );
          useNotificationStore.getState().addNotification(
  ...
  describe('Preferences', () => {
    ...
    describe('setChannelNotificationLevel', () => {
      it('should set channel notification level', () => {
        ...
        const settings =
          useNotificationStore.getState().preferences.channelSettings['channel-1'];
  ...
  describe('Selectors', () => {
    ...
    describe('selectUnreadMentions', () => {
      it('should return mention count', () => {
        act(() => {
          useNotificationStore.getState().addNotification(
            createTestNotification({ type: 'mention' })
          );
        });
