...
export const DEFAULT_PLANS: Plan[] = [
  {
    ...
    features: [
      { id: 'channels', name: 'Public Channels', description: 'Create public channels', included: true, limit: 5 },
      { id: 'members', name: 'Team Members', description: 'Invite team members', included: true, limit: 10 },
      { id: 'storage', name: 'File Storage', description: 'Store files and media', included: true, limit: 100 },
      { id: 'messages', name: 'Message History', description: 'Access message history', included: true, limit: 10000 },
      { id: 'integrations', name: 'Integrations', description: 'Connect third-party apps', included: false },
      ...
      { id: 'support', name: 'Priority Support', description: '24/7 priority support', included: false },
    ],
  },
  {
    id: 'plan_pro',
    ...
    trialDays: 14,
    features: [
      { id: 'channels', name: 'Unlimited Channels', description: 'Create unlimited channels', included: true },
      { id: 'members', name: 'Team Members', description: 'Invite team members', included: true, limit: 100 },
      { id: 'storage', name: 'File Storage', description: 'Store files and media', included: true, limit: 10000 },
      { id: 'messages', name: 'Unlimited History', description: 'Access full message history', included: true },
      { id: 'integrations', name: 'Integrations', description: 'Connect third-party apps', included: true, limit: 10 },
      { id: 'analytics', name: 'Basic Analytics', description: 'View usage analytics', included: true },
      { id: 'sso', name: 'SSO', description: 'Single sign-on', included: false },
      { id: 'support', name: 'Priority Support', description: '24/7 priority support', included: false },
    ],
  },
  {
    ...
    features: [
      { id: 'channels', name: 'Unlimited Channels', description: 'Create unlimited channels', included: true },
      { id: 'members', name: 'Unlimited Members', description: 'Invite unlimited members', included: true },
      { id: 'storage', name: 'Unlimited Storage', description: 'Store unlimited files', included: true },
      { id: 'messages', name: 'Unlimited History', description: 'Access full message history', included: true },
      { id: 'integrations', name: 'Unlimited Integrations', description: 'Connect unlimited apps', included: true },
      { id: 'analytics', name: 'Advanced Analytics', description: 'Advanced usage analytics', included: true },
