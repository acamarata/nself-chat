...
export const ANIMATION_PRESETS = {
  ...
  /** Bounce animations */
  bounce: {
    normal: { duration: 400, easing: 'cubic-bezier(0.68, -0.55, 0.265, 1.55)', property: 'transform' },
    reduced: { duration: 0.01, easing: 'linear', property: 'opacity' },
  },
  /** Spring animations */
  spring: {
    normal: { duration: 500, easing: 'cubic-bezier(0.175, 0.885, 0.32, 1.275)', property: 'transform' },
    reduced: { duration: 0.01, easing: 'linear', property: 'opacity' },
  },
} as const;
