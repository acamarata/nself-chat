  ...
  describe('CapacitorFileSystemAdapter', () => {
    ...
    beforeEach(() => {
      mockFilesystem = {
        ...
        stat: jest.fn().mockResolvedValue({ type: 'file', size: 100, mtime: Date.now(), uri: '/path' }),
    ...
    describe('readDir', () => {
      it('returns directory contents', async () => {
        mockFilesystem.readdir.mockResolvedValue({
          files: [
            { name: 'file1.txt', type: 'file', size: 100, mtime: Date.now(), uri: '/path/file1.txt' },
  ...
  describe('ElectronFileSystemAdapter', () => {
    ...
    beforeEach(() => {
      ...
      mockDialog = {
        ...
        showSaveDialog: jest.fn().mockResolvedValue({ canceled: false, filePath: '/path/file.txt' }),
      };
