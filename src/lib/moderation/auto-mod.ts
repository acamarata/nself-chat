...
export const DEFAULT_ESCALATION_CONFIG: EscalationConfig = {
  ...
  thresholds: [
    ...
    { warningCount: 3, action: 'mute', durationMs: 300000, reason: 'Multiple warnings - 5 minute mute' },
    { warningCount: 5, action: 'mute', durationMs: 3600000, reason: 'Repeated violations - 1 hour mute' },
    { warningCount: 10, action: 'ban', durationMs: 86400000, reason: 'Severe violations - 24 hour ban' },
  ],
