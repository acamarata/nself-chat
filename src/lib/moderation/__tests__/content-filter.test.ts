...
describe('ContentFilter Class', () => {
  ...
  describe('checkLinks', () => {
    it('should detect excessive links', () => {
      const manyLinks = 'Check http://a.com http://b.com http://c.com http://d.com http://e.com http://f.com';
    ...
    it('should respect linkEnabled setting', () => {
      ...
      const result = filter.checkLinks('Visit http://evil.com http://a.com http://b.com http://c.com http://d.com http://e.com');
      expect(result.length).toBe(0);
    });
