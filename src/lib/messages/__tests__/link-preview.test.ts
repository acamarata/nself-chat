...
describe('Link Preview Module', () => {
  ...
  describe('resolveUrl', () => {
    it('should return absolute URL unchanged', () => {
      expect(resolveUrl('https://example.com', 'https://other.com/image.png')).toBe('https://other.com/image.png');
    });

    it('should resolve protocol-relative URL', () => {
      expect(resolveUrl('https://example.com', '//cdn.example.com/image.png')).toBe('https://cdn.example.com/image.png');
    });
    ...
    it('should resolve relative URL', () => {
      expect(resolveUrl('https://example.com/page/', 'image.png')).toBe('https://example.com/page/image.png');
    });
  ...
  describe('getFirstUrl', () => {
    it('should return first URL', () => {
      expect(getFirstUrl('First https://first.com then https://second.com')).toBe('https://first.com');
    });
  ...
  describe('parseBasicMeta', () => {
    ...
    it('should parse favicon', () => {
      ...
      expect(parseBasicMeta(html, 'https://example.com').favicon).toBe('https://example.com/favicon.ico');
    });

    it('should parse shortcut icon', () => {
      const html = '<link rel="shortcut icon" href="/icon.png">';
      expect(parseBasicMeta(html, 'https://example.com').favicon).toBe('https://example.com/icon.png');
    });

    it('should use apple touch icon as fallback', () => {
      const html = '<link rel="apple-touch-icon" href="/apple-icon.png">';
      expect(parseBasicMeta(html, 'https://example.com').favicon).toBe('https://example.com/apple-icon.png');
    });
