...
describe('useChannelTyping', () => {
  ...
  describe('handleInputChange', () => {
    ...
    it('should throttle typing emissions', () => {
      ...
      const callCountAfterFirst = (socketClient.emit as jest.Mock).mock.calls
        .filter((call) => call[0] === SocketEvents.TYPING_START).length;
      ...
      const callCountAfterSecond = (socketClient.emit as jest.Mock).mock.calls
        .filter((call) => call[0] === SocketEvents.TYPING_START).length;
      ...
      const callCountAfterThrottle = (socketClient.emit as jest.Mock).mock.calls
        .filter((call) => call[0] === SocketEvents.TYPING_START).length;
