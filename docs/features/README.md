...
#### [📊 Feature Comparison](Features-Complete)
...
#### [📞 Voice Calling](VOICE-CALLING-COMPLETE)
...
#### [🔒 Two-Factor Authentication](../security/2FA-Implementation-Summary)
...
#### [🔍 Enhanced Search](../reference/Search-Quick-Start)
...
- [💬 Messaging](Features-Messaging) - Complete chat system
- [📞 Voice Calling](VOICE-CALLING-COMPLETE) - Team calls
- [🖥️ Screen Sharing](Screen-Sharing-Complete) - Presentations
- [📊 Polls](Polls-Implementation) - Team decisions

### For Remote Teams
- [📹 Video Calling](WebRTC-Calling-Complete) - Face-to-face meetings
- [📺 Live Streaming](Live-Streaming-Complete) - Company all-hands
- [🔐 E2EE](E2EE-Complete) - Secure communications
- [🔍 Search](../reference/Search-Quick-Start) - Find anything fast

### For Enterprise
- [🔒 2FA](../security/2FA-Implementation-Summary) - Account security
- [🔐 PIN Lock](../security/PIN-LOCK-SYSTEM) - Device security
- [🏢 Enterprise Features](../guides/enterprise/README) - SSO, RBAC, Audit
- [🎨 White-Label](White-Label-Guide) - Your brand

### For Developers
- [🤖 Bots](Bots) - Automate workflows
- [🔌 Plugins](Plugins) - Extend functionality
- [📡 API](../api/API-DOCUMENTATION) - Integration
...
**[Edit this page on GitHub](https://github.com/acamarata/nself-chat/edit/main/docs/features/README.md)**
